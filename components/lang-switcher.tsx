  ...
  return (
    ...
    >
      ...
      <svg
        className={cn(
          'mx-1 h-4 w-4',
          'transition-transform group-hover/langsw:scale-[1.17] group-hover/langsw:-translate-x-0.5_ group-focus-visible/langsw:scale-[1.17] group-focus-visible/langsw:-translate-x-0.5_ motion-reduce:transition-none',
