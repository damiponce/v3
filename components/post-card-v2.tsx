...
const PostCard = ({ itemKey, url, date, title, category, excerpt }: Props) => {
      ...
      <div className='group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
        ...
        <div className='z-10 sm:col-span-8'>
          <header>
            ...
            <span className='text-xs font-semibold tracking-wide text-neutral-500 whitespace-pre-line uppercase inline-flex'>
              <span className=''>
